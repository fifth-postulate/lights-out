...
knownKernels =
    empty
        ...
        |> add 2 2 2 (Array.fromList [])
        |> add 3 2 2 (Array.fromList [ 1, 1, 1, 1 ])
        |> add 4 2 2 (Array.fromList [])
        |> add 5 2 2 (Array.fromList [])
        |> add 6 2 2 (Array.fromList [ 2, 2, 2, 2 ])
        |> add 7 2 2 (Array.fromList [])
        |> add 8 2 2 (Array.fromList [])
        |> add 9 2 2 (Array.fromList [ 3, 3, 3, 3 ])
        |> add 10 2 2 (Array.fromList [])
        |> add 2 3 2 (Array.fromList [ 1, 1, 1, 0, 1, 0 ])
        |> add 2 3 2 (Array.fromList [ 1, 0, 1, 1, 0, 1 ])
        |> add 3 3 2 (Array.fromList [ 1, 0, 2, 2, 0, 1 ])
        |> add 4 3 2 (Array.fromList [ 2, 2, 2, 0, 2, 0 ])
        |> add 4 3 2 (Array.fromList [ 1, 0, 3, 3, 0, 1 ])
        |> add 5 3 2 (Array.fromList [ 1, 0, 4, 4, 0, 1 ])
        |> add 6 3 2 (Array.fromList [ 3, 3, 3, 0, 3, 0 ])
        |> add 6 3 2 (Array.fromList [ 1, 0, 5, 5, 0, 1 ])
        |> add 7 3 2 (Array.fromList [ 1, 0, 6, 6, 0, 1 ])
        |> add 8 3 2 (Array.fromList [ 4, 4, 4, 0, 4, 0 ])
        |> add 8 3 2 (Array.fromList [ 1, 0, 7, 7, 0, 1 ])
        |> add 9 3 2 (Array.fromList [ 1, 0, 8, 8, 0, 1 ])
        |> add 10 3 2 (Array.fromList [ 5, 5, 5, 0, 5, 0 ])
        |> add 10 3 2 (Array.fromList [ 1, 0, 9, 9, 0, 1 ])
        |> add 2 4 2 (Array.fromList [])
        |> add 3 4 2 (Array.fromList [])
        |> add 4 4 2 (Array.fromList [])
        |> add 5 4 2 (Array.fromList [ 1, 3, 3, 1, 1, 3, 3, 1 ])
        |> add 6 4 2 (Array.fromList [])
        |> add 7 4 2 (Array.fromList [])
        |> add 8 4 2 (Array.fromList [])
        |> add 9 4 2 (Array.fromList [])
        |> add 10 4 2 (Array.fromList [ 2, 6, 6, 2, 2, 6, 6, 2 ])
        |> add 2 5 2 (Array.fromList [ 1, 0, 1, 0, 1, 1, 0, 1, 0, 1 ])
        |> add 3 5 2 (Array.fromList [ 0, 2, 2, 1, 2, 1, 2, 1, 1, 0 ])
        |> add 3 5 2 (Array.fromList [ 2, 0, 1, 0, 2, 1, 0, 2, 0, 1 ])
        |> add 4 5 2 (Array.fromList [ 1, 0, 3, 0, 1, 3, 0, 1, 0, 3 ])
        |> add 5 5 2 (Array.fromList [ 1, 0, 4, 0, 1, 4, 0, 1, 0, 4 ])
        |> add 6 5 2 (Array.fromList [ 0, 2, 2, 4, 2, 4, 2, 4, 4, 0 ])
        |> add 6 5 2 (Array.fromList [ 1, 0, 5, 0, 1, 5, 0, 1, 0, 5 ])
        |> add 7 5 2 (Array.fromList [ 1, 0, 6, 0, 1, 6, 0, 1, 0, 6 ])
        |> add 8 5 2 (Array.fromList [ 1, 0, 7, 0, 1, 7, 0, 1, 0, 7 ])
        |> add 9 5 2 (Array.fromList [ 0, 3, 3, 6, 3, 6, 3, 6, 6, 0 ])
        |> add 9 5 2 (Array.fromList [ 1, 0, 8, 0, 1, 8, 0, 1, 0, 8 ])
        |> add 10 5 2 (Array.fromList [ 1, 0, 9, 0, 1, 9, 0, 1, 0, 9 ])
